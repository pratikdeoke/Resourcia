...
export default function ManageResources() {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      setFormData({ ...formData, name: "", type: "", capacity: 0, location: "" });
      load();
    } catch (err) {
    ...
    <div className="max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-500">Add and manage the assets of your organization.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        <div className="lg:col-span-1 bg-white border border-slate-200 rounded-3xl p-6 shadow-sm sticky top-24">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h2 className="font-bold text-slate-800">New Resource</h2>
          </div>
          ...
          <form onSubmit={handleCreate} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input required className={inputClass} value={formData.organizationId} 
                  onChange={(e) => setFormData({...formData, organizationId: e.target.value})} placeholder="Paste UUID..." />
              </div>
            </div>
              ...
              <div className="col-span-2">
                ...
                <div className="relative">
                  ...
                  <input required className={inputClass} value={formData.name} 
                    onChange={(e) => setFormData({...formData, name: e.target.value})} placeholder="e.g. Studio A" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input required className={inputClass} value={formData.type} 
                    onChange={(e) => setFormData({...formData, type: e.target.value})} placeholder="Classroom" />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input type="number" className={inputClass} value={formData.capacity} 
                    onChange={(e) => setFormData({...formData, capacity: parseInt(e.target.value)})} placeholder="0" />
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input className={inputClass} value={formData.location} 
                  onChange={(e) => setFormData({...formData, location: e.target.value})} placeholder="e.g. North Wing" />
              </div>
            </div>

            <button disabled={loading} type="submit" className="w-full bg-slate-900 text-white py-3 rounded-xl font-bold hover:bg-slate-800 transition-all shadow-lg flex items-center justify-center gap-2 mt-4">
